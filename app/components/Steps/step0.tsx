    ...
    <div className="pl-8">
      <div className="relative w-fit">
        ...
        <div className="relative rounded-[32px] p-[1.5px] bg-[linear-gradient(to_top,rgba(255,255,255,0.95)_0%,rgba(255,255,255,0.8)_10%,rgba(255,255,255,0.2)_40%,rgba(255,255,255,0.1)_60%,rgba(255,255,255,0.2)_80%)]">
          ...
          <div className="absolute inset-0 scale-[calc(100%+2px)] rounded-[32px] opacity-401 bg-[linear-gradient(to_right,#BB00FF_0%,#FF4D00_50%,#FF0033_100%)] [mask-image:linear-gradient(to_top,black_0%,transparent_50%)] mix-blend-color-dodge"></div>

          <div className="animate-fade-in relative z-10 rounded-[31px] backdrop-blur-md px-8 py-6">
