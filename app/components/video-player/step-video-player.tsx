...
export default function VideoPlayer({ nextVideoPath, direction, className }:
    {
        nextVideoPath: string,
        direction: "left" | "right" | "center",
        className?: string
    }) {
    const { sceneNumber, categoryNumber } = useScene();
    ...
    const BASE_URL = `/bg_video/${nextVideoPath}_${direction}.mp4`;
