...
export default function UspPopupBox({text, type = "warm", className}: {text: string, type?: "warm" | "cold", className?: string}) {
  return (
    <div className="absolute left-4 top-4 w-fit mt-24 rounded-[32px] overflow-hidden text-white">  
          {/* 그라데이션 */}
          <p className={cn(
            "absolute inset-0 scale-[calc(100%+2px)] blur-lg opacity-40",
