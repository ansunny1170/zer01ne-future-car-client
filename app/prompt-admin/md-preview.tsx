    ...
    return (
        <div className="text-sm leading-relaxed text-neutral-200">
            <ReactMarkdown
                ...
                components={{
                    h1: (p) => <h1 className="mt-5 mb-3 border-b border-neutral-700 pb-1 text-xl font-bold" {...p} />,
                    ...
                    blockquote: (p) => (
                        <blockquote className="my-2 border-l-2 border-neutral-600 pl-3 text-neutral-400" {...p} />
                    ),
                    ...
                    th: (p) => <th className="border border-neutral-700 bg-neutral-800 px-2 py-1 text-left" {...p} />,
                    ...
                    code: (p) => {
                        ...
                        return isBlock ? (
                            ...
                            <code className="rounded bg-neutral-800 px-1 py-0.5 font-mono text-[0.85em] text-amber-300" {...rest}>
                                {children}
                            </code>
                        );
                    },
                    pre: (p) => (
                        <pre
                            className="my-3 overflow-x-auto rounded-lg border border-neutral-700 bg-[#0d1117] p-3 font-mono text-xs leading-relaxed"
                            {...p}
                        />
                    ),
                }}
...
export function PreviewModal({
    ...
    return (
        ...
        >
            <div
                className="flex h-full w-full max-w-5xl flex-col rounded-xl border border-neutral-700 bg-neutral-900 shadow-2xl"
                onClick={(e) => e.stopPropagation()}
            >
                <div className="flex items-center justify-between border-b border-neutral-800 px-5 py-3">
                    <span className="font-mono text-sm text-neutral-300">{title} — 미리보기</span>
                    <button
                        onClick={onClose}
